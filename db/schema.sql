...
create table dw_registry(
    ...
    registry_created_at timestamp NULL,
    registry_updated_at timestamp NULL,
    registry_expires_at timestamp NULL,
...
create table dw_watcher(
    ...
    CONSTRAINT registry_id_fkey FOREIGN KEY (registry_id) REFERENCES domainwatcher.dw_registry(id),
